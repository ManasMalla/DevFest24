...
export default function page() {
    ...
    return (
        <div className="w-full h-screen border bg-gray-800 
        border-gray-700 flex flex-col justify-center items-center">
            <div className="w-full p-4">
                ...
                <p className="text-sm font-normal text-gray-400 text-center">Be a part of the fabulous event.</p>
                        ...
                        DomainsList.map((item, index) => (
                            <li key={index}
                                ...
                                className="flex items-center p-3 text-base font-bold rounded-lg group hover:shadow bg-gray-600 hover:bg-gray-500 text-white cursor-pointer">
                                    {item.icon}
                                    <span className="flex-1 ms-3 whitespace-nowrap">{item.domain}</span>
                            </li>
                        ))
                    }
                </ul>
